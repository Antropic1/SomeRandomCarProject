...
#include "SomeRandomCarProjectOffroadCar.h"
#include "SomeRandomCarProjectOffroadWheelFront.h"
#include "SomeRandomCarProjectOffroadWheelRear.h"
...
ASomeRandomCarProjectOffroadCar::ASomeRandomCarProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USomeRandomCarProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USomeRandomCarProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USomeRandomCarProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USomeRandomCarProjectOffroadWheelRear::StaticClass();
