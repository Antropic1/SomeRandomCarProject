...
#include "SomeRandomCarProjectSportsCar.h"
#include "SomeRandomCarProjectSportsWheelFront.h"
#include "SomeRandomCarProjectSportsWheelRear.h"
...
ASomeRandomCarProjectSportsCar::ASomeRandomCarProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USomeRandomCarProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USomeRandomCarProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USomeRandomCarProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USomeRandomCarProjectSportsWheelRear::StaticClass();
