...
#include "SomeRandomCarProjectOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class SOMERANDOMCARPROJECT_API ASomeRandomCarProjectOffroadCar : public ASomeRandomCarProjectPawn
{
	GENERATED_BODY()
...
public:
	...
	ASomeRandomCarProjectOffroadCar();
};
